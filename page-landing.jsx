...
const PROCESO_SHORT = [
  "Brief por WhatsApp, llamada o correo — como te sea más fácil.",
  "Cotización clara con productos, técnica y plazos. Sin costos ocultos.",
  "Primero aprobás la muestra. Si algo no calza, lo corregimos antes.",
  "Producción en Lima con control de calidad pieza por pieza.",
  "Lo entregamos donde lo necesites — oficina, evento o a domicilio.",
];
        ...
        {PROCESO.map((s, i) => (
          <React.Fragment key={s.num}>
            <Reveal className="proceso-step" delay={i * 60}>
              ...
              <div className="proceso-step-desc">{PROCESO_SHORT[i]}</div>
            </Reveal>
            {i < PROCESO.length - 1 && (
